...
if (form) {
  form.addEventListener("submit", function (e) {
    ...
    const sheetURL = "https://script.google.com/macros/s/AKfycby4jb7qKTk40iRHxnOeOIMxe9-VHjBWiaFcNKIhujZ1_9tKj479urKRd1WpOS-ccIFG/exec"; // Replace with actual Apps Script URL
